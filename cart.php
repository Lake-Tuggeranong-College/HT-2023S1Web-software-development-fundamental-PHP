...
<div class="cart">
    ...
    <div class="container-fluid">
        ...
        foreach ($_SESSION["ShoppingCart"] as $product) {
            ...
            <div class="row">
                <div class="col-2">
                    <img src='images/siteImages/<?php echo $product["image"]; ?>' width="50" height="40"/>
                </div>
...
<form method="post">
    ...
    if(isset($_POST['orderProducts'])) {
        ...
        foreach ($_SESSION["ShoppingCart"] as $row) {
                ...
                // Write to the Db.
                $conn->exec("INSERT INTO Orders (OrderNumber,CustomerID, ProductID, OrderDate, ProductQuantity) VALUES('$orderNumber','$customerID','$productID','$orderDate', '$quantity')");
